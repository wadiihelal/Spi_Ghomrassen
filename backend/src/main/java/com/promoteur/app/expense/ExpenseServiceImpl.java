...
import com.promoteur.app.vat.VatAmounts;
import com.promoteur.app.vat.VatCalculationService;
...
public class ExpenseServiceImpl implements ExpenseService {
    ...
    private void map(final Expense expense, final ExpenseRequest request) {
        ...
        expense.setPaymentMethod(request.getPaymentMethod() != null ? request.getPaymentMethod() : com.promoteur.app.shared.PaymentMethod.OTHER);
