...
public final class SpecificationSupport {
     ...
     */
    public static void whenId(final List<Predicate> predicates, final CriteriaBuilder builder,
     ...
     */
    public static void whenText(final List<Predicate> predicates, final CriteriaBuilder builder,
     ...
     */
    public static void whenSearch(final List<Predicate> predicates, final CriteriaBuilder builder,
     ...
     */
    public static Path<String> joined(final Root<?> root, final String association, final String attribute) {
    ...
    public static Predicate all(final CriteriaBuilder builder, final List<Predicate> predicates) {
     ...
     */
    public static <T extends Number> Expression<T> orZero(final CriteriaBuilder builder,
