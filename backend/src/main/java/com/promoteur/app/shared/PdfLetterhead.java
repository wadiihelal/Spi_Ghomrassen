...
/**
 * The look the printed output shares (UX-06).
 *
 ...
 */
public final class PdfLetterhead {
     ...
     */
    public static void open(final Document document, final CompanyProperties company,
    ...
    public static Paragraph heading(final String text) {
     ...
     */
    public static PdfPTable facts(final String[][] rows) {
    ...
    public static PdfPCell headerCell(final String value) {
    ...
    public static PdfPCell bodyCell(final String value) {
        return PdfLetterhead.bodyCell(value, Element.ALIGN_LEFT);
    }

    public static PdfPCell amountCell(final String value) {
        return PdfLetterhead.bodyCell(value, Element.ALIGN_RIGHT);
    }

    public static PdfPCell bodyCell(final String value, final int alignment) {
    ...
    public static PdfPCell totalCell(final String value, final int alignment) {
     ...
     */
    public static Paragraph note(final String text) {
     ...
     */
    public static PdfPTable signatures(final String left, final String right) {
